...
// void fit_std_main_loop_test(const double *Xpointer,std::vector<double> &y_std,double& y_mean,const double *Xtestpointer, xinfo_sizet &Xorder_std,
//     size_t N,size_t p,size_t N_test,
//     size_t M, size_t L, size_t N_sweeps, xinfo_sizet &max_depth_std, 
//     size_t Nmin, size_t Ncutpoints, double alpha, double beta, 
//     double tau, size_t burnin, size_t mtry, 
...
//                 trees.t[tree_ind].grow_tree_adaptive_abarth_train(sum_vec(residual_std) / (double)N, 0, max_depth_std[sweeps][tree_ind], 
//                                                 Nmin, Ncutpoints, tau, sigma, alpha, beta, draw_sigma, 
//                                                 draw_mu, parallel, residual_std, Xorder_std, Xpointer, 
//                                                 mtry, run_time, use_all, mtry_weight_current_tree, split_count_current_tree);

...
# check bcf original
t2 = proc.time()
bcf_fit = bcf_ini(xbcf_fit$treedraws_pr, xbcf_fit$treedraws_trt, y, z, x, x, pihat, nburn=2000, nsim=2000, include_pi = "control",use_tauscale = TRUE, ntree_control = treesmu, ntree_moderate = treestau)
t2 = proc.time() - t2

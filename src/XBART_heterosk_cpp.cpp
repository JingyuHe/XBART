                              ...
                              )
{
    ...
    // TODO: check if maybe one state object is enough for two models
    ...
    // mcmc loop
    // TODO: determine the appropriate set of input variables
    mcmc_loop_heterosk(Xorder_std, verbose, sigma_draw_xinfo, *trees2, no_split_penality, state, model, x_struct);

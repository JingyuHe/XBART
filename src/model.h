...
//////////////////////////////////////////////////////////////////////////////////////
//  LogNormal Model, for XBART regression variance, or XBCF same tree for treated / control
//////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////
//  LogNormal XBCF Model, treated / control have different variance tree
//////////////////////////////////////////////////////////////////////////////////////

class logNormalXBCFModel : public Model
{
public:
    double kap;
    double s;
    ...
    logNormalXBCFModel(double tau_a, double tau_b, double kap, double s, double tau, double alpha, double beta) : Model(1, 2)
    {
        this->kap = kap;
        this->s = s;
        this->tau = tau;
    ...
    logNormalXBCFModel() : Model(1, 2) {}

    // redefined functions
    void ini_residual_std(State &state, matrix<double> &mean_residual_std, X_struct &x_struct_v_con, X_struct &x_struct_v_trt);

    void ini_residual_std2(State &state, X_struct &x_struct_v_con, X_struct &x_struct_v_trt);
    ...
    void state_sweep(State &state, size_t tree_ind, size_t M, matrix<double> &residual_std, X_struct &x_struct_v_con, X_struct &x_struct_v_trt) const;

    void predict_std(matrix<double> &Ztestpointer, const double *Xtestpointer, size_t N_test, size_t p, size_t num_trees, size_t num_sweeps, matrix<double> &yhats_test_xinfo, vector<vector<tree>> &trees_con, vector<vector<tree>> &trees_trt);

    void update_state(State &state, size_t tree_ind, X_struct &x_struct_v_con, X_struct &x_struct_v_trt);
...
class logNormalXBCFModel2 : public Model
{
public:
    double kap;
    double s;
    ...
    logNormalXBCFModel2() : Model(1, 2) {}

    // redefined functions
    void ini_residual_std(State &state, matrix<double> &mean_residual_std, X_struct &x_struct_v_con, X_struct &x_struct_v_mod);

    void ini_residual_std2(State &state, X_struct &x_struct_v_con, X_struct &x_struct_v_mod);
    ...
    void update_state(State &state, X_struct &x_struct_v_con, X_struct &x_struct_v_mod);

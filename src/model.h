...
class Model
{
  ...
  public:
	...
	virtual void samplePars_scalar(bool draw_mu, double y_mean, size_t N_Xorder, double sigma, double tau,
								   std::mt19937 &generator, double &theta) const { return; };
...
class NormalModel : public Model
{
  ...
  public:
	...
	void samplePars_scalar(bool draw_mu, double y_mean, size_t N_Xorder, double sigma, double tau, std::mt19937 &generator, double &theta) const
	{
		std::normal_distribution<double> normal_samp(0.0, 1.0);
		if (draw_mu == true)
		{

...
class hskNormalModel : public NormalModel
{
public:

    // constructors
    hskNormalModel(double kap, double s, double tau, double alpha, double beta) : NormalModel(kap, s, tau, alpha, beta) {}
    hskNormalModel(double kap, double s, double tau, double alpha, double beta, bool sampling_tau, double tau_kap, double tau_s) : NormalModel(kap, s, tau, alpha, beta, sampling_tau, tau_kap, tau_s) {}
    hskNormalModel() : NormalModel() {}
...
class logNormalModel : public NormalModel
{
public:

    // constructors
    logNormalModel(double kap, double s, double tau, double alpha, double beta) : NormalModel(kap, s, tau, alpha, beta) {}
    logNormalModel(double kap, double s, double tau, double alpha, double beta, bool sampling_tau, double tau_kap, double tau_s) : NormalModel(kap, s, tau, alpha, beta, sampling_tau, tau_kap, tau_s) {}
    logNormalModel() : NormalModel() {}
    ...
    void ini_residual_std(std::unique_ptr<State> &state, matrix<double> &mean_residual_std);

    void predict_std(const double *Xtestpointer, size_t N_test, size_t p, size_t num_trees, size_t num_sweeps, matrix<double> &yhats_test_xinfo, vector<vector<tree>> &trees);

    //new functions added
    void update_sigmas(matrix<double> &mean_residual_std, matrix<double> &var_residual_std);
};

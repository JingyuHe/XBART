...
// XBCF_continuous_cpp
Rcpp::List XBCF_continuous_cpp(arma::mat y, arma::mat Z, arma::mat X, arma::mat X_ps, arma::mat X_trt, arma::mat Xtest, arma::mat Xtest_ps, arma::mat Xtest_trt, arma::mat Ztest, size_t num_trees, size_t num_trees_ps, size_t num_trees_trt, size_t num_sweeps, size_t max_depth, size_t n_min, size_t num_cutpoints, double alpha, double beta, double tau, double no_split_penality, size_t burnin, size_t mtry, size_t mtry_ps, size_t mtry_trt, size_t p_categorical, size_t p_categorical_ps, size_t p_categorical_trt, double kap, double s, double tau_kap, double tau_s, bool verbose, bool sampling_tau, bool parallel, bool set_random_seed, size_t random_seed, bool sample_weights, double nthread);
RcppExport SEXP _XBART_XBCF_continuous_cpp(SEXP ySEXP, SEXP ZSEXP, SEXP XSEXP, SEXP X_psSEXP, SEXP X_trtSEXP, SEXP XtestSEXP, SEXP Xtest_psSEXP, SEXP Xtest_trtSEXP, SEXP ZtestSEXP, SEXP num_treesSEXP, SEXP num_trees_psSEXP, SEXP num_trees_trtSEXP, SEXP num_sweepsSEXP, SEXP max_depthSEXP, SEXP n_minSEXP, SEXP num_cutpointsSEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP tauSEXP, SEXP no_split_penalitySEXP, SEXP burninSEXP, SEXP mtrySEXP, SEXP mtry_psSEXP, SEXP mtry_trtSEXP, SEXP p_categoricalSEXP, SEXP p_categorical_psSEXP, SEXP p_categorical_trtSEXP, SEXP kapSEXP, SEXP sSEXP, SEXP tau_kapSEXP, SEXP tau_sSEXP, SEXP verboseSEXP, SEXP sampling_tauSEXP, SEXP parallelSEXP, SEXP set_random_seedSEXP, SEXP random_seedSEXP, SEXP sample_weightsSEXP, SEXP nthreadSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< arma::mat >::type Xtest_ps(Xtest_psSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type Xtest_trt(Xtest_trtSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_XBART_XBCF_continuous_cpp", (DL_FUNC) &_XBART_XBCF_continuous_cpp, 38},

...
// XBART_heterosk_cpp (TODO: update once the input variables are set)
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type sample_weights_flag(sample_weights_flagSEXP);
    Rcpp::traits::input_parameter< double >::type nthread(nthreadSEXP);
    rcpp_result_gen = Rcpp::wrap(XBART_heterosk_cpp(y, X, Xtest, num_trees, num_sweeps, max_depth, n_min, num_cutpoints, alpha, beta, tau, no_split_penality, burnin, mtry, p_categorical, kap, s, tau_kap, tau_s, verbose, sampling_tau, parallel, set_random_seed, random_seed, sample_weights_flag, nthread));
    return rcpp_result_gen;
END_RCPP
}
// xbart_predict
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_XBART_XBART_heterosk_cpp", (DL_FUNC) &_XBART_XBART_heterosk_cpp, 26}, // TODO: update accordingly

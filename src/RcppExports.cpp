...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type tau(tauSEXP);
    rcpp_result_gen = Rcpp::wrap(XBCF_rd_predict(Xpred_con, Xpred_mod, Zpred, Xtr_con, Xtr_mod, Ztr, tree_con, tree_mod, res_indicator_con, valid_residuals_con, resid_mean_con, res_indicator_mod, valid_residuals_mod, resid_mean_mod, sigma0, sigma1, local_ate, p_categorical_mod, cutoff, Owidth, Omin, theta, tau));
    return rcpp_result_gen;
END_RCPP
}
// xbart_predict_full
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_XBART_XBCF_rd_predict", (DL_FUNC) &_XBART_XBCF_rd_predict, 23},

...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(XBART_cpp(y, X, Xtest, num_trees, num_sweeps, max_depth, n_min, num_cutpoints, alpha, beta, tau, no_split_penality, burnin, mtry, p_categorical, kap, s, verbose, parallel, set_random_seed, random_seed, sample_weights_flag, nthread));
    return rcpp_result_gen;
END_RCPP
}
// XBART_CLT_cpp

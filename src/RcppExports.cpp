...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< size_t >::type large_tree_size(large_tree_sizeSEXP);
    Rcpp::traits::input_parameter< size_t >::type extra_trees(extra_treesSEXP);
    rcpp_result_gen = Rcpp::wrap(XBART_multinomial_cpp(y, num_class, X, num_trees, num_sweeps, max_depth, n_min, num_cutpoints, alpha, beta, tau_a, tau_b, no_split_penalty, burnin, mtry, p_categorical, verbose, parallel, set_random_seed, random_seed, sample_weights, separate_tree, weight, update_weight, update_tau, update_phi, nthread, a, weight_exponent, MH_step, large_tree_size, extra_trees));
    return rcpp_result_gen;
END_RCPP
}
// XBCF_continuous_cpp

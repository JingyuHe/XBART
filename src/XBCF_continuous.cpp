...
// [[Rcpp::plugins(cpp11)]]
// [[Rcpp::export]]
Rcpp::List XBCF_continuous_cpp(arma::mat y,
                               arma::mat Z,
                               arma::mat X_con,
                               arma::mat X_mod,
                               ...
                               double nthread = 0)
{
    ...
    // define model
    XBCFContinuousModel model(kap, s, tau_con, tau_mod, alpha_con, beta_con, alpha_mod, beta_mod, sampling_tau, tau_con_kap, tau_con_s, tau_mod_kap, tau_mod_s);

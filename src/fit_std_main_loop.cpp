...
//     std::cout << "Start : " << y_std << std::endl;

    

//     // Residual for 0th tree 
//     fit_info->residual_std = z - fit_info->yhat_std + fit_info->predictions_std[0];
...
//             //z = z- fit_info->predictions_std[tree_ind];
//             fit_info->yhat_std = fit_info->yhat_std - fit_info->predictions_std[tree_ind];

//             //std::cout << "Temp z " << z << std::endl;
...
//             std::cout << "Pred " << fit_info->yhat_std;
//         }
//         // save predictions to output matrix
//         yhats_xinfo[sweeps] = fit_info->yhat_std;

...
// [[Rcpp::plugins(cpp11)]]
// [[Rcpp::export]]
Rcpp::List XBCF_discrete_heterosk_vary_variance_cpp(arma::mat y,
                                                    arma::mat Z,
                                                    arma::mat X_con,
                                                    arma::mat X_mod,
                                                    ...
                                                    double nthread = 0)
{
    ...
    logNormalXBCFModel *model_v = new logNormalXBCFModel(a_v, b_v, kap, s, 0, alpha_v, beta_v);
    ...
    ////////////////////////////////////////////////////////////////
    mcmc_loop_xbcf_discrete_heteroskedastic_vary_variance(Xorder_std_con, Xorder_std_mod,

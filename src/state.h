...
public:
    ...
    matrix<double> *residual_std = nullptr; // a matrix to save all residuals, partial residuals
    matrix<size_t> *Xorder_std = nullptr;
    ...
    // Splits
    matrix<double> *split_count_all_tree = nullptr;
    std::vector<double> *split_count_all = nullptr;
    std::vector<double> *split_count_current_tree = nullptr;
    std::vector<double> *mtry_weight_current_tree = nullptr;
    ...
    const double *X_std = nullptr;        // pointer to original data
    std::vector<double> *y_std = nullptr; // pointer to y data
    size_t max_depth;
    size_t num_trees;
    size_t num_sweeps;
    size_t burnin;
    ...
    // Logit Model
    // lambdas
    std::vector<std::vector<std::vector<double>>> *lambdas = nullptr;
    std::vector<std::vector<std::vector<double>>> *lambdas_separate = nullptr;
    size_t weight_exponent;
    double logloss_last_sweep;

    // for heteroskedastic XBART
    matrix<double> *split_count_all_tree_m = nullptr;
    std::vector<double> *split_count_all_m = nullptr;
    std::vector<double> *mtry_weight_current_tree_m = nullptr;
    matrix<double> *split_count_all_tree_v = nullptr;
    std::vector<double> *split_count_all_v = nullptr;
    std::vector<double> *mtry_weight_current_tree_v = nullptr;

    // for heteroskedastic XBCF
    matrix<double> *split_count_all_tree_v_con = nullptr;
    matrix<double> *split_count_all_tree_v_mod = nullptr;
    std::vector<double> *split_count_all_v_con = nullptr;
    std::vector<double> *split_count_all_v_mod = nullptr;
    std::vector<double> *mtry_weight_current_tree_v_con = nullptr;
    std::vector<double> *mtry_weight_current_tree_v_mod = nullptr;

    bool forest_flag;              // 0 = mean forest; 1 = variance forest
    std::vector<double> *mean_res = nullptr; // temporary storage for mean model residual
    std::vector<double> *precision = nullptr;
    // for XBCF different variance for treated / control
    std::vector<double> *precision_con = nullptr;
    std::vector<double> *precision_mod = nullptr;
    std::vector<double> *res_x_precision = nullptr;
    size_t n_min_m;
    size_t n_min_v;
    ...
    matrix<double> *split_count_all_tree_con = nullptr;
    std::vector<double> *split_count_all_con = nullptr;
    std::vector<double> *mtry_weight_current_tree_con = nullptr;
    matrix<double> *split_count_all_tree_mod = nullptr;
    std::vector<double> *split_count_all_mod = nullptr;
    std::vector<double> *mtry_weight_current_tree_mod = nullptr;
    const double *X_std_con = nullptr; // pointer to original data
    const double *X_std_mod = nullptr; // pointer to original data

    matrix<double> *Z_std = nullptr;
    std::vector<double> *tau_fit = nullptr;
    std::vector<double> *mu_fit = nullptr;
    std::vector<double> *total_fit = nullptr;
    bool treatment_flag;
    matrix<size_t> *Xorder_std_con = nullptr;
    matrix<size_t> *Xorder_std_mod = nullptr;
    size_t p_con;
    size_t p_mod;
    ...
    // for survival forest
    bool survival;
    std::vector<double> *delta_std = nullptr;
    std::vector<double> *y_imputed = nullptr;
    std::vector<double> *y_imputed_save = nullptr;
    ...
    {
        delete residual_std;
        delete split_count_all_tree;
        delete split_count_all;
        delete split_count_current_tree;
        delete mtry_weight_current_tree;
        delete lambdas;
        delete lambdas_separate;
        delete split_count_all_tree_m;
        delete split_count_all_m;
        delete mtry_weight_current_tree_m;
        delete split_count_all_tree_v;
        delete split_count_all_v;
        delete mtry_weight_current_tree_v;
        delete split_count_all_tree_v_con;
        delete split_count_all_tree_v_mod;
        delete split_count_all_v_con;
        delete split_count_all_v_mod;
        delete mtry_weight_current_tree_v_con;
        delete mtry_weight_current_tree_v_mod;
        delete mean_res;
        delete precision;
        delete precision_con;
        delete precision_mod;
        delete res_x_precision;
        delete split_count_all_tree_con;
        delete split_count_all_con;
        delete mtry_weight_current_tree_con;
        delete split_count_all_tree_mod;
        delete split_count_all_mod;
        delete mtry_weight_current_tree_mod;
        delete tau_fit;
        delete mu_fit;
        delete total_fit;
        delete y_imputed;
        delete y_imputed_save;
    }

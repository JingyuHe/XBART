...
public:
    ...
    void grow_from_root_rd(State &state, matrix<size_t> &Xorder_std, std::vector<size_t> &X_counts, std::vector<size_t> &X_num_unique, Model *model, X_struct &x_struct, 
    ...
    void rd_predict_from_root(matrix<size_t> &Xorder_std, rd_struct &x_struct, std::vector<size_t> &X_counts, std::vector<size_t> &X_num_unique,
                              ...
                              matrix<double> &yhats_test_xinfo, std::vector<bool> active_var, const size_t &p_categorical,

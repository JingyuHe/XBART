                            ...
                            bool set_random_seed = false, size_t random_seed = 0,double a = 1/50, double b=1/50)
{
    ...
    it_std_poisson_classification(Xpointer, y_std, y_mean, Xtestpointer, Xorder_std,
              N, p, N_test, M, L, N_sweeps, max_depth_std,
              Nmin, Ncutpoints, alpha, beta, tau, burnin, mtry,
              draw_sigma,  a,  b, // beta a,b 
              verbose,  m_update_sigma,draw_mu,  parallel,yhats_xinfo, 
              sigma_draw_xinfo,p_categorical,  p_continuous, trees,  

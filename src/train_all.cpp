                ...
                bool sample_weights_flag = true)
{
    ...
    std::unique_ptr<State> state_trt(new NormalState(Xpointer, Xorder_std, N, p, num_trees_trt, p_categorical, p_continuous, set_random_seed, random_seed, n_min, num_cutpoints, parallel, mtry, Xpointer, num_sweeps, sample_weights_flag, &y_std, 1.0, max_depth, y_mean, burnin, model_trt->dim_residual));

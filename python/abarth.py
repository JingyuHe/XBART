...
class Abarth(_object):
    ...
    def fit(self, n: 'int') -> "double":
        return _abarth.Abarth_fit(self, n)

    def fit_x(self, n: 'int') -> "double":
        return _abarth.Abarth_fit_x(self, n)

    def sort_x(self, n: 'int', size: 'int') -> "void":
        return _abarth.Abarth_sort_x(self, n, size)

    def predict(self, n: 'int', size: 'int') -> "void":
        return _abarth.Abarth_predict(self, n, size)

    def __predict_2d(self, n: 'int', size: 'int') -> "void":
        return _abarth.Abarth___predict_2d(self, n, size)

    def fit_predict(self, n: 'int', n_y: 'int', n_test: 'int', size: 'int') -> "void":
        return _abarth.Abarth_fit_predict(self, n, n_y, n_test, size)

    def fit_predict_all(self, n: 'int', n_y: 'int', n_test: 'int', size: 'int', p_cat: 'size_t') -> "void":
        return _abarth.Abarth_fit_predict_all(self, n, n_y, n_test, size, p_cat)

    def predict_all(self, n: 'int') -> "void":
        return _abarth.Abarth_predict_all(self, n)

    def fit_all(self, n: 'int', n_y: 'int', p_cat: 'size_t') -> "void":
        return _abarth.Abarth_fit_all(self, n, n_y, p_cat)

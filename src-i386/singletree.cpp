...
// [[Rcpp::export]]
Rcpp::List singletree(arma::vec y, arma::mat X, size_t depth, size_t max_depth = 100, size_t Nmin = 5, double tau = 10, double sigma = 1, double alpha = 0.95, double beta = 2){

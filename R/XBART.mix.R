XBART.mix <- function(y, X, Xtest, Z, Ztest, theta_mu, theta_cov, num_trees, num_sweeps, max_depth = 250, 
    ...
    obj = XBART_mix_cpp(y, X, Xtest, Z, Ztest, theta_mu, theta_cov, num_trees, num_sweeps, max_depth, 

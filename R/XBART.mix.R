XBART.mix <- function(y, X, Xtest, Z, Ztest, num_trees, num_sweeps, max_depth = 250, 
    Nmin = 1, num_cutpoints = 100, alpha = 0.95, beta = 1.25, tau = NULL, 
    no_split_penality = NULL, burnin = 1L, mtry = NULL, p_categorical = 0L, 
    kap = 16, s = 4, tau_kap = 3, tau_s = 0.5, delta = 1, verbose = FALSE, sampling_tau = TRUE, parallel = TRUE, random_seed = NULL, 
    ...
    obj = XBART_mix_cpp(y, X, Xtest, Z, Ztest, num_trees, num_sweeps, max_depth, 
        Nmin, num_cutpoints, alpha, beta, tau, no_split_penality, burnin, 
        mtry, p_categorical, kap, s, tau_kap, tau_s, delta, verbose, sampling_tau, parallel, set_random_seed, 

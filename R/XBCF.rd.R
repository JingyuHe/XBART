#' XBCF causal forest for regression discontinuity design
...
XBCF.rd <- function(y, W, X, c, Owidth = 0.1, Omin = 10, Opct = 0.7, num_trees_con = 30, num_trees_mod = 10, num_sweeps = 60, 
                    ...
                    pr_scale = FALSE, trt_scale = FALSE, a_scaling = TRUE, b_scaling = TRUE, verbose = FALSE, 
                    update_tau = TRUE, parallel = TRUE, random_seed = NULL, sample_weights = TRUE, nthread = 0, 
                    ...) {

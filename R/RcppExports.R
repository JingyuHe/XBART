...
XBART_survival_cpp <- function(y, X, tau, num_sweeps, burnin, p_categorical, mtry, no_split_penalty_m, num_trees_m, max_depth_m, n_min_m, num_cutpoints_m, tau_m, no_split_penalty_v, num_trees_v, max_depth_v, n_min_v, num_cutpoints_v, a_v, b_v, ini_var, kap = 16, s = 4, tau_kap = 3, tau_s = 0.5, alpha = 0.95, beta = 1.25, alpha_v = 0.95, beta_v = 1.25, verbose = FALSE, sampling_tau = TRUE, parallel = TRUE, set_random_seed = FALSE, random_seed = 0L, sample_weights = TRUE, nthread = 0) {
    .Call(`_XBART_XBART_survival_cpp`, y, X, tau, num_sweeps, burnin, p_categorical, mtry, no_split_penalty_m, num_trees_m, max_depth_m, n_min_m, num_cutpoints_m, tau_m, no_split_penalty_v, num_trees_v, max_depth_v, n_min_v, num_cutpoints_v, a_v, b_v, ini_var, kap, s, tau_kap, tau_s, alpha, beta, alpha_v, beta_v, verbose, sampling_tau, parallel, set_random_seed, random_seed, sample_weights, nthread)
}

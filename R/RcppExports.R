...
gp_predict <- function(y, X, Xtest, tree_pnt, resid, p_categorical = 0L) {
    .Call(`_XBART_gp_predict`, y, X, Xtest, tree_pnt, resid, p_categorical)
}

...
train_forest_adaptive <- function(y, X, Xtest, M, L, N_sweeps, max_depth, Ncutpoints, Nmin, alpha, beta, tau, draw_sigma, kap = 16, s = 4, verbose = FALSE, m_update_sigma = FALSE, draw_mu = FALSE) {
    .Call(`_SpikySmoothTrees_train_forest_adaptive`, y, X, Xtest, M, L, N_sweeps, max_depth, Ncutpoints, Nmin, alpha, beta, tau, draw_sigma, kap, s, verbose, m_update_sigma, draw_mu)
}
